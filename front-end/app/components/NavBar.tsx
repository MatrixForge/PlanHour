...
const NavBar: React.FC<NavBarProps> = ({ loggedIn, cardsRef }) => {
    ...
    const handleLogout = () => {
        useAuthStore.getState().logout(); // Assuming you have a logout function in your auth store
    ...
    return (
        <nav className={`navbar navbar-expand-lg ${styles_nav.fontCustom} ${styles_nav.navbarBackground}`}>
